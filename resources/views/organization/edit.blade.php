...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-body">
            ...
            <form class="container" action="{{ route('organization.edit', $organization) }}" method="POST">
                @csrf
                <div class=" row mb-4">
                ...
                <div class=" row mb-4">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control @error('location') is-invalid @enderror"" name="location"
                            id="location-input" value="{{ old('location')? old('location') : $organization->location }}" placeholder="Enter location">
                        @error('location')
                            <p class="text-muted">{{ $message }}</p>
                        @enderror
                    </div>
