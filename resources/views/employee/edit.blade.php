    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-body">
                ...
                <form class="container" action="{{ route('employee.edit', $employee) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class=" mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control @error('name') is-invalid @enderror""
                                    name="name" id="name-input" value="{{ old('name') ? old('name') : $employee->user->name }}"
                            ...
                            <div class="col-sm-12">
                                <select name="designation" id="designation"
                                    ...
                                    @foreach ($designations as $designation)
                                        ...
                                        @if (old('designation_id')) {{ old('designation_id') == $designation->id ? 'selected' : '' }} @else {{ $employee->designation_id == $designation->id ? 'selected' : '' }} @endif>
                                            {{ $designation->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="email" class="form-control @error('email') is-invalid @enderror""
                                    name="email" id="email-input" value="{{ old('email')? old('email') : $employee->user->email }}" placeholder="Enter E-mail">
                                @error('email')
                                    <p class="text-muted">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="contact_no"
                                    ...
                                    value="{{ old('contact_no') ? old('contact_no') : $employee->user->contact_no }}" id="contact_no-input" placeholder="Enter contact_no">
                                @error('contact_no')
                                    <p class="text-muted">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="cnic"
                                    ...
                                    value="{{ old('cnic') ? old('cnic') : $employee->user->cnic }}" placeholder="Enter cnic">
                                @error('cnic')
                                    <p class="text-muted">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" name="father_name"
                                    ...
                                    value="{{ old('father_name') ? old('father_name') : $employee->father_name }}" id="father_name-input" placeholder="Enter father_name">
                                @error('father_name')
                                    <p class="text-muted">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="date" name="dob" value="{{ old('dob') ? old('dob') : $employee->user->dob }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="date" name="joining_date" value="{{ old('joining_date') ? old('joining_date') : $employee->joining_date }}"
                                    class="form-control @error('joining_date') is-invalid @enderror" id="joining_date-input"
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control @error('qualification') is-invalid @enderror"
                                    name="qualification" id="qualification-input" value="{{ old('qualification') ? old('qualification') : $employee->qualification }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="salary" name="salary"
                                    ...
                                    value="{{ old('salary') ? old('salary') : $employee->salary }}" id="salary-input" placeholder="Enter salary">
                                @error('salary')
                                    <p class="text-muted">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-12 row">
                                <div class="col-md-4">
                                    ...
                                    <input type="radio" name="relationship_status" checked
                                        class="form-check-inpu @error('relationship_status') is-invalid @enderror" value="Single"
                                        placeholder="Enter relationship_status">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-check-label" for="exampleRadios1">Married</label>
                                    <input type="radio" name="relationship_status"
                                        class="form-check-inpu @error('relationship_status') is-invalid @enderror" value="Female"
                                        placeholder="Enter relationship_status">
                                </div>
