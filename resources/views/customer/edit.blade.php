    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-body">
                ...
                <form class="container" action="{{ route('customer.edit', $customer) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control @error('name') is-invalid @enderror""
                                    name="name" id="name-input" value="{{ old('name') ? old('name') : $customer->name }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control @error('contact_person') is-invalid @enderror"
                                    name="contact_person" id="contact_person-input" value="{{ old('contact_person') ? old('contact_person') : $customer->contact_person }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" id="email-input" value="{{ old('email') ? old('email') : $customer->email }}" placeholder="Enter E-mail">
                                @error('email')
                                    <p class="text-muted">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="mobile_no"
                                    class="form-control @error('mobile_no') is-invalid @enderror" value="{{ old('mobile_no') ? old('mobile_no') : $customer->mobile_no }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="phone_no"
                                    class="form-control @error('phone_no') is-invalid @enderror" value="{{ old('phone_no') ? old('phone_no') : $customer->phone_no }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="address" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ old('address') ? old('address') : $customer->address }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="ntn_no"
                                    class="form-control @error('ntn_no') is-invalid @enderror" value="{{ old('ntn_no') ? old('ntn_no') : $customer->ntn_no }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="strn_no"
                                    class="form-control @error('strn_no') is-invalid @enderror" value="{{ old('strn_no') ? old('strn_no') : $customer->strn_no }}"
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <div class="col-sm-12">
                                <input type="number" name="fax_no"
                                    class="form-control @error('fax_no') is-invalid @enderror" value="{{ old('fax_no') ? old('fax_no') : $customer->fax_no }}"
                        ...
                        <div class= "mb-4 col-md-4">
                            ...
                            <div class="col-sm-12 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="radio" name="status" {{ old('status') == $customer->status ? 'checked' : $customer->status }}
