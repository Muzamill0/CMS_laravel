...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-body">
            ...
            <form class="container" action="{{ route('organization.edit', $organization) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="mb-4 col-md-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('name') is-invalid @enderror"" name="name"
                                id="name-input" value="{{ old('name') ? old('name') : $organization->name }}" placeholder="Enter Organization name">
                            @error('name')
                    ...
                    <div class="mb-4 col-md-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('owner_name') is-invalid @enderror"" name="owner_name"
                                id="owner_name-input" value="{{ old('owner_name') ? old('owner_name') : $organization->owner_name }}" placeholder="Enter owner_name">
                            @error('owner_name')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('email') is-invalid @enderror"" name="email"
                                id="email-input" value="{{ old('email') ? old('email') : $organization->email }}" placeholder="Enter email">
                            @error('email')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('address') is-invalid @enderror"" name="address"
                                id="address-input" value="{{ old('address') ? old('address') : $organization->address }}" placeholder="Enter address">
                            @error('address')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control @error('mobile_no') is-invalid @enderror"" name="mobile_no"
                                id="mobile_no-input" value="{{ old('mobile_no') ? old('namobile_nome') : $organization->mobile_no }}" placeholder="Enter phone number">
                            @error('mobile_no')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control @error('ph_no') is-invalid @enderror"" name="ph_no"
                                id="ph_no-input" value="{{ old('ph_no') ? old('ph_no') : $organization->ph_no }}" placeholder="Enter phone number">
                            @error('ph_no')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control @error('sales_tax_no') is-invalid @enderror"" name="sales_tax_no"
                                id="sales_tax_no-input" value="{{ old('sales_tax_no') ? old('sales_tax_no') : $organization->sales_tax_no }}" placeholder="Enter sales tax">
                            @error('sales_tax_no')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control @error('ntn_no') is-invalid @enderror"" name="ntn_no"
                                id="ntn_no-input" value="{{ old('ntn_no') ? old('ntn_no') : $organization->ntn_no }}" placeholder="Enter NTN No">
                            @error('ntn_no')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('tag_line') is-invalid @enderror""
                                name="tag_line" id="tag_line-input" value="{{ old('tag_line') ? old('tag_line') : $organization->tag_line }}"
