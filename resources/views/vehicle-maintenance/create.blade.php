...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-body">
            ...
            <form class="container" action="{{ route('vehicle.maintenance.create') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('type') is-invalid @enderror"" name="type"
                                id="type-input" value="{{ old('type') }}" placeholder="Enter maintenance type">
                            @error('type')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            id="cost-input" value="{{ old('cost') }}" placeholder="Enter Cost">
                            @error('cost')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 col-md-4">
                        ...
                        <div class="col-sm-12">
                            ...
                            id="provider-input" value="{{ old('provider') }}" placeholder="Enter Service Provider">
                            @error('provider')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4  mb-4">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('location') is-invalid @enderror"" name="location"
                                id="location-input" value="{{ old('location') }}" placeholder="Enter Provider Location">
                            @error('location')
                                <p class="text-muted">{{ $message }}</p>
                            @enderror
                        </div>
